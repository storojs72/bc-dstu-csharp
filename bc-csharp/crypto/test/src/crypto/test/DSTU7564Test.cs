...
namespace Org.BouncyCastle.Crypto.Tests
{
     ...
     public class Dstu7564Test : DigestTest
     {
          ...
          public Dstu7564Test()
               : base(new Dstu7564Digest(256), new string[0], new string[0])
          { }
          ...
          private ITestResult Hash256Tests()
          {
               int n = 256;
               ...
               Dstu7564Digest dstu7564 = new Dstu7564Digest(n);
          ...
          private ITestResult Hash384Tests()
          {
               int n = 384;
          ...
          private ITestResult Hash512Tests()
          {
               int n = 512;
               ...
               if (!Arrays.AreEqual(expectedHash, hash))
               {
                    return new SimpleTestResult(false, Name + ": Failed hash-512 test 6 - expected "
                         + Hex.ToHexString(expectedHash)
                         + " got " + Hex.ToHexString(hash).ToUpper());
               }
          ...
          private ITestResult MacTests()
          {
               ...
               byte[] mac = new byte[n / 8];
                              
               DSTU7564Mac dstu7564mac = new DSTU7564Mac(n);
