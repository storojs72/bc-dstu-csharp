		...
		: IBlockCipher
    {
        ...
        */
            ...
            int         outOff)
        {
            ...
            //Console.WriteLine("gamma: " + Org.BouncyCastle.Utilities.Encoders.Hex.ToHexString(cfbOutV));
            ...
            //Console.WriteLine("cipher: " + Org.BouncyCastle.Utilities.Encoders.Hex.ToHexString(outBytes));
