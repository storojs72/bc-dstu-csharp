...
namespace Org.BouncyCastle.Crypto.Tests
{
     ...
     public class Dstu7624Test : CipherTest
     {
          ...
          private ITestResult CcmTests()
          {
               ...
               dstu7624ccm.ProcessAadBytes(authText, 0, authText.Length, input.Length);
          ...
          private ITestResult XtsTests()
          {
               ...
               KXtsSBlockCipher dstu7624xts = new KXtsSBlockCipher(new Dstu7624Engine(128, 128));
               ...
               dstu7624xts = new KXtsSBlockCipher(new Dstu7624Engine(128, 256));
               ...
               dstu7624xts = new KXtsSBlockCipher(new Dstu7624Engine(256, 256));
               param = new ParametersWithIV(new KeyParameter(key), iv);
               ...
               dstu7624xts = new KXtsSBlockCipher(new Dstu7624Engine(256, 512));
               param = new ParametersWithIV(new KeyParameter(key), iv);
               ...
               if (!Arrays.AreEqual(output, expectedCipherText))
               {
                    return new SimpleTestResult(false, Name + ": Failed XTS encrypt test 4 - expected "
                         + Hex.ToHexString(expectedCipherText)
                         + " got " + Hex.ToHexString(output).ToUpper());
               }
               ...
               dstu7624xts = new KXtsSBlockCipher(new Dstu7624Engine(512, 512));
               param = new ParametersWithIV(new KeyParameter(key), iv);
          ...
          private ITestResult GcmTests()
          {
               ...
               Array.Copy(expectedEncrypted, 0, expectedOutput, 0, expectedEncrypted.Length);
               Array.Copy(expectedMac, 0, expectedOutput, expectedEncrypted.Length, expectedMac.Length);
               ...
               Array.Copy(expectedMac, 0, decrypted, plainText.Length, mac.Length);
               ...
               Array.Resize(ref decrypted, plainText.Length);
