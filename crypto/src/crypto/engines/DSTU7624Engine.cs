...
{
     /**
     * Implementation of DSTU 7624 (Ukrainian national standard of block encryption).
     * Thanks to Roman Oliynykov' native C implementation: https://github.com/Roman-Oliynykov/Kalyna-reference
     */
         ...
         : IBlockCipher
     {
          ...
          public virtual void Init(bool forEncryption, ICipherParameters parameters)
          {
               ...
               if (parameters is KeyParameter)
               {
                    ...
                    BasicKeyExpand(workingKey, kt);

                    ExtendedKeyExpand(workingKey, kt);
          ...
          private void BasicKeyExpand(ulong[] key, ulong[] kt)
          {
          ...
          private void ExtendedKeyExpand(ulong[] key, ulong[] kt)
          {
          ...
          private void Encrypt(byte[] plain, int inOff, byte[] cipherText, int outOff)
          {
               ...
               //{
               //     //Console.WriteLine("{0:x}", internalState[i]);
               //     Console.WriteLine(Org.BouncyCastle.Utilities.Encoders.Hex.ToHexString(plain));
               //}
          ...
          {
               //Console.WriteLine(Org.BouncyCastle.Utilities.Encoders.Hex.ToHexString(cipherText));
               //Console.WriteLine();
               ...
               //Console.WriteLine(Org.BouncyCastle.Utilities.Encoders.Hex.ToHexString(cipherText));
               //Console.WriteLine(inOff);
               //for (int i = 0; i < cipherText_.Length; i++)
               //{
               //     Console.WriteLine("{0:x}", cipherText_[i]);
               //}
          ...
          private void MatrixMultiply(byte[][] matrix)
          {
               ...
               //for (int i = 0; i < internalState.Length; i++)
               //{
               //     Console.WriteLine(internalState[i]);
               //     //Console.WriteLine(Org.BouncyCastle.Utilities.Encoders.Hex.ToHexString(stateBytes));
               //}
               //Console.ReadLine();
          }
